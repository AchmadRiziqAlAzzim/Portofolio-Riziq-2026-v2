  ...
  <section id="login" class="h-dvh overflow-hidden">
    <div class="flex justify-center items-center h-dvh overflow-hidden">
      <div class="grid grid-cols-1 lg:grid-cols-2 w-full max-w-5xl">
        ...
        <div class="h-auto bg-white pt-10 p-10 rounded-s-xl shadow-[0_6px_0px_rgba(0,0,0,0.25)]">
          <h1 class="text-center text-3xl text-[#0062ff] font-bold">
            Daftar <i class="fa-solid fa-graduation-cap ms-1"></i>
          </h1>
          ...
          <form method="POST" class="max-w-sm mx-auto mt-10">
            ...
            <div class="w-full max-w-md">
              ...
              <div class="flex">
                ...
                <span
                  id="togglePassword"
                  class="inline-flex items-center px-4 border rounded-e-lg cursor-pointer">
                  <i id="icon" class="fa-solid fa-eye"></i>
                </span>
              </div>

              <label class="block mb-2.5 text-sm font-medium mt-4">Region</label>
              <select name="region" class="block w-full px-3 py-3 border rounded-lg focus:border-blue-600">
              ...
              <button type="submit" name="daftar"
                class="group relative flex items-center justify-center gap-3 mt-6
           w-full bg-[#0062ff] text-white px-6 py-3.5 rounded-lg
